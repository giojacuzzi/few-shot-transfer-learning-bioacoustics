...
# - Path to the directory containing all prediction scores for the evaluation dataset (e.g. "data/interim/OESF_1.0/test/segment_perf/source"), generated by eval_segment_perf.py
...
model = f'data/interim/{target_model_stub}/test/segment_perf/{model_tag}'
