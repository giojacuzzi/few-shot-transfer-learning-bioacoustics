...
# - Path to the directory containing all prediction scores for the evaluation dataset (e.g. "data/interim/OESF_1.0/test/sample_perf/source")
...
model = f'data/interim/{target_model_stub}/test/sample_perf/{model_tag}'
out_dir = f'results/{target_model_stub}/test/sample_perf/confusion_matrix'
